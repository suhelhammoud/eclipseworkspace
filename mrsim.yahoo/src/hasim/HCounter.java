...
public class HCounter extends HashMap<CTag, Double>{
	/**
...
private static final Logger logger = Logger.getLogger(HCounter.class);
	...
	final static private  DecimalFormat format=new DecimalFormat();
        ...
        final static Formatter fmt=new Formatter();
        static{
...
//		super(CTag.ctagComp);
	...
	public String toString(String pre) {
		...
		Map<CTag, Double> out=new TreeMap<CTag, Double>(this);
		StringBuffer sb=new StringBuffer();
		for (Map.Entry<CTag, Double> e:out.entrySet()){
