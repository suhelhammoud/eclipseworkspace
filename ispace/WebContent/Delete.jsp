...
Statement deletefiles = ConnGet_User_Files.createStatement();
	if(request.getParameter("cb") != null){
		String[] delete=request.getParameterValues("cb");
		for( int i=0; i!=delete.length; i++)
		deletefiles.executeUpdate("Update files set flag=1 where fileid='"+delete[i]+"'");
		deletefiles.close();
		}
...
<div align="right" class="style2">
  <p align="right"><a href="Help.jsp">Help</a> <a href="<%= MM_Logout %>">Log out</a></p>
  <p align="center">&nbsp;</p>
  <p align="center" class="style3">Welcome <%= (String)session.getValue("MM_Username") %></p>
  <p align="center">&nbsp;</p>
  ...
  <form name="form1" action="Delete.jsp" method="post">
    <p align="center">
      <input type="submit" name="deletefiles" value="Delete File(s)">
    </p>
