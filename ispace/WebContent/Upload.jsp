...
PreparedStatement StatementGet_User_Files = ConnGet_User_Files.prepareStatement("SELECT filename, filesize  FROM mydatabase.files  WHERE username = '" + Get_User_Files__MMColParam + "' AND flag=0");
...
<body>
<p align="right" class="style3"><a href="Help.jsp">Help</a> <a href="<%= MM_Logout %>">Log out</a></p>
<p align="center" class="style3">&nbsp;</p>
<p align="center" class="style11">Welcome <%= (String)session.getValue("MM_Username") %></p>
<p align="center" class="style3">&nbsp;</p>
